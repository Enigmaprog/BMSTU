...
#Заполнение большой матрицы и маленькой матрицы
...
#Преобразую матрицы методом Гаусса
...
#Объединяю большую и маленькую матрицы
def mult(col, b):
    n = len(col)
